...
public class GUI {
    ...
    int font_size2 = 20;
    int font_size3 = 15;
    int LoginPositionX = (width / 2) - 185;
    int LoginPositionY = (height / 2) - 150;
    int UserPositionX = 200;
    int UserPositionY = 100;
    int ContentPositionX = 200;
    int ContentPositionY = 200;
    int arraySize = 100;
    int length;

    String FrameTitle = "Supermarket Management";
    String AdminPassword = "khadiza";
    String FontDefault = "proxima-nova";
    ...
    GUI() throws Exception {
        ...
        labelLogin.setBounds(LoginPositionX + 125, LoginPositionY, 120, 60);
        labelLogin.setFont(new Font(FontDefault, Font.BOLD, font_size1));

        labelUsername = new JLabel("Username ");
        labelUsername.setBounds(LoginPositionX, LoginPositionY + 100, 120, 30);
        labelUsername.setFont(new Font(FontDefault, Font.BOLD, font_size3));

        labelPassword = new JLabel("Password ");
        labelPassword.setFont(new Font(FontDefault, Font.BOLD, font_size3));
        labelPassword.setBounds(LoginPositionX, LoginPositionY + 140, 120, 30);

        // login textfields
        textfieldUsername = new JTextField();
        textfieldUsername.setBounds(LoginPositionX + 120, LoginPositionY + 100, 250, 30);
        textfieldUsername.setFont(new Font(FontDefault, Font.PLAIN, font_size3));

        passwordFieldUser = new JPasswordField();
        passwordFieldUser.setBounds(LoginPositionX + 120, LoginPositionY + 140, 250, 30);
        passwordFieldUser.setFont(new Font(FontDefault, Font.PLAIN, font_size3));

        // Buttons
        btnUserLoginAttempt = new JButton("Login");
        btnUserLoginAttempt.setBounds(LoginPositionX + 120, LoginPositionY + 200, 100, 30);
        btnUserLoginAttempt.setFont(new Font(FontDefault, Font.BOLD, font_size3));
        ...
        btnUserSignupPanel.setBounds(LoginPositionX + 270, LoginPositionY + 200, 100, 30);
        btnUserSignupPanel.setFont(new Font(FontDefault, Font.BOLD, font_size3));
        ...
        btnAdmin.setFont(new Font(FontDefault, Font.BOLD, font_size3));
        ...
        btnUserLoginAttempt.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                if (users.illegalUserTextInput(textfieldUsername.getText()) || users.illegalUserTextInput(String.valueOf(passwordFieldUser.getPassword()))) {
                    ...
                    labelUserMarketHeader.setBounds(UserPositionX, UserPositionY, 400, 30);
                    labelUserMarketHeader.setFont(new Font(FontDefault, Font.BOLD, font_size1));

                    labelUserMarketItemIDHeader = new JLabel("Item ID");
                    labelUserMarketItemIDHeader.setBounds(200, 150, 100, 30);
                    labelUserMarketItemIDHeader.setFont(new Font(FontDefault, Font.BOLD, font_size3));

                    labelUserMarketItemNameHeader = new JLabel("Item Name");
                    labelUserMarketItemNameHeader.setBounds(300, 150, 300, 30);
                    labelUserMarketItemNameHeader.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                    ...
                    labelUserMarketPricePerQuantityHeader.setFont(new Font(FontDefault, Font.BOLD, font_size3));

                    labelUserMarketQuantityHeader = new JLabel("Quantity");
                    labelUserMarketQuantityHeader.setBounds(650, 150, 100, 30);
                    labelUserMarketQuantityHeader.setFont(new Font(FontDefault, Font.BOLD, font_size3));

                    labelUserMarketPriceHeader = new JLabel("Price");
                    labelUserMarketPriceHeader.setBounds(750, 150, 100, 30);
                    labelUserMarketPriceHeader.setFont(new Font(FontDefault, Font.BOLD, font_size3));

                    labelUserMarketTotalPriceHeader = new JLabel("Total Price");
                    labelUserMarketTotalPriceHeader.setBounds(650, height - 100, 100, 30);
                    labelUserMarketTotalPriceHeader.setFont(new Font(FontDefault, Font.BOLD, font_size3));

                    labelUserMarketTotalPrice = new JLabel("0.0");
                    labelUserMarketTotalPrice.setBounds(750, height - 100, 100, 30);
                    labelUserMarketTotalPrice.setFont(new Font(FontDefault, Font.BOLD, font_size2));
                    ...
                    labelProfileHeader.setBounds(UserPositionX, UserPositionY, 400, 30);
                    labelProfileHeader.setFont(new Font(FontDefault, Font.BOLD, font_size1));

                    labelProfileUsername = new JLabel("Username");
                    labelProfileUsername.setBounds(UserPositionX, UserPositionY + 100, 200, 30);
                    labelProfileUsername.setFont(new Font(FontDefault, Font.BOLD, font_size3));

                    labelProfileMobileNo = new JLabel("Mobile No");
                    labelProfileMobileNo.setBounds(UserPositionX, UserPositionY + 150, 200, 30);
                    labelProfileMobileNo.setFont(new Font(FontDefault, Font.BOLD, font_size3));

                    labelProfilePassword = new JLabel("Password");
                    labelProfilePassword.setBounds(UserPositionX, UserPositionY + 200, 200, 30);
                    labelProfilePassword.setFont(new Font(FontDefault, Font.BOLD, font_size3));

                    textfieldEditUsername = new JTextField();
                    textfieldEditUsername.setText(username);
                    textfieldEditUsername.setBounds(UserPositionX + 100, UserPositionY + 100, 250, 30);
                    textfieldEditUsername.setFont(new Font(FontDefault, Font.PLAIN, font_size3));

                    textfieldEditMobileNo = new JTextField();
                    textfieldEditMobileNo.setText(mobileNo);
                    textfieldEditMobileNo.setBounds(UserPositionX + 100, UserPositionY + 150, 250, 30);
                    textfieldEditMobileNo.setFont(new Font(FontDefault, Font.PLAIN, font_size3));

                    passfieldEditPassword = new JPasswordField();
                    passfieldEditPassword.setText(password);
                    passfieldEditPassword.setBounds(UserPositionX + 100, UserPositionY + 200, 250, 30);
                    passfieldEditPassword.setFont(new Font(FontDefault, Font.PLAIN, font_size3));

                    // user orders elements
                    labelUserOrdersHeader = new JLabel("ORDERS");
                    labelUserOrdersHeader.setBounds(UserPositionX, UserPositionY, 400, 30);
                    labelUserOrdersHeader.setFont(new Font(FontDefault, Font.BOLD, font_size1));

                    labelUserOrderIDHeader = new JLabel("Order ID");
                    labelUserOrderIDHeader.setBounds(200, 150, 100, 30);
                    labelUserOrderIDHeader.setFont(new Font(FontDefault, Font.BOLD, font_size3));

                    labelUserOrderDateHeader = new JLabel("Order Date");
                    labelUserOrderDateHeader.setBounds(300, 150, 300, 30);
                    labelUserOrderDateHeader.setFont(new Font(FontDefault, Font.BOLD, font_size3));

                    labelUserOrderTotalPriceHeader = new JLabel("Total Price");
                    labelUserOrderTotalPriceHeader.setBounds(600, 150, 100, 30);
                    labelUserOrderTotalPriceHeader.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                    ...
                    btnUserProfile.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                    ...
                    btnUserDeleteAccount.setBounds(width - 340, height - 100, 150, 50);
                    btnUserDeleteAccount.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                    ...
                    btnUserSaveChanges.setBounds(width - 170, height - 100, 150, 50);
                    btnUserSaveChanges.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                    ...
                    btnUserMarket.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                    ...
                    btnUserMarketPlaceOrder.setBounds(width - 170, height - 100, 150, 50);
                    btnUserMarketPlaceOrder.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                    ...
                    btnUserMarketCalculate.setBounds(170, height - 100, 150, 50);
                    btnUserMarketCalculate.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                    ...
                    btnUserOrders.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                    ...
                    btnUserOrderView.setBounds(width - 170, height - 100, 150, 50);
                    btnUserOrderView.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                    ...
                    btnUserLogout.setBounds(0, height - 100, 150, 50);
                    btnUserLogout.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                    ...
                    for (int i = 0; i <= items.newItemID; i++) {
                        ...
                        labelUserMarketItemID[i].setFont(new Font(FontDefault, Font.PLAIN, font_size3));

                        labelUserMarketItemName[i] = new JLabel(items.itemName[i]);
                        labelUserMarketItemName[i].setBounds(300, (150 + 30 * (i + 1)), 300, 30);
                        labelUserMarketItemName[i].setFont(new Font(FontDefault, Font.PLAIN, font_size3));
                        ...
                        labelUserMarketPricePerQuantity[i].setFont(new Font(FontDefault, Font.PLAIN, font_size3));
                        ...
                        textfieldUserMarketItemQuantity[i].setFont(new Font(FontDefault, Font.PLAIN, font_size3));

                        labelUserMarketPrice[i] = new JLabel();
                        labelUserMarketPrice[i].setText("0.0");
                        labelUserMarketPrice[i].setBounds(750, (150 + 30 * (i + 1)), 50, 30);
                        labelUserMarketPrice[i].setFont(new Font(FontDefault, Font.PLAIN, font_size3));
                    ...
                    for (int i = orders.newOrderID, j = 0; i >= 0; i--) {
                        if (orders.username[i].equals(username)) {
                            ...
                            labelUserOrderID[j].setFont(new Font(FontDefault, Font.PLAIN, font_size3));

                            labelUserOrderDate[j] = new JLabel(orders.date[i]);
                            labelUserOrderDate[j].setBounds(300, (150 + 30 * (j + 1)), 300, 30);
                            labelUserOrderDate[j].setFont(new Font(FontDefault, Font.PLAIN, font_size3));
                            ...
                            labelUserOrderTotalPrice[j].setFont(new Font(FontDefault, Font.PLAIN, font_size3));
                        ...
                        public void actionPerformed(ActionEvent arg0) {
                            for (int i = 0; i <= orders.newOrderID; i++) {
                                if (checkboxUserOrders[i].isSelected()) {
                                    ...
                                    labelTotalPrice.setBounds(700, height - 100, 300, 30);
                                    labelTotalPrice.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                                    ...
                                    try {
                                        for (int k = 0; k < arrayItemsName.length; k++) {
                                            ...
                                            labelItemID[k].setFont(new Font(FontDefault, Font.PLAIN, font_size3));
                                            ...
                                            labelItemName[k].setFont(new Font(FontDefault, Font.PLAIN, font_size3));
                                            ...
                                            labelItemPricePerQuantity[k].setFont(new Font(FontDefault, Font.PLAIN, font_size3));

                                            labelItemQuantity[k] = new JLabel(arrayItemsQuantity[k]);
                                            labelItemQuantity[k].setBounds(700, 150 + 30 * (k + 1), 100, 30);
                                            labelItemQuantity[k].setFont(new Font(FontDefault, Font.PLAIN, font_size3));
                                            ...
                                            labelItemPrice[k].setFont(new Font(FontDefault, Font.PLAIN, font_size3));
                                    ...
                                    frameViewOrder.setSize(width, height);
        ...
        btnUserSignupPanel.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                btnUserLoginPanel.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                ...
                labelUserSignup.setBounds(LoginPositionX + 125, LoginPositionY, 120, 60);
                labelUserSignup.setFont(new Font(FontDefault, Font.BOLD, font_size1));

                labelSignupUsername = new JLabel("Username ");
                labelSignupUsername.setBounds(LoginPositionX, LoginPositionY + 100, 120, 30);
                labelSignupUsername.setFont(new Font(FontDefault, Font.BOLD, font_size3));

                labelSignupMobileNumber = new JLabel("Mobile No ");
                labelSignupMobileNumber.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                labelSignupMobileNumber.setBounds(LoginPositionX, LoginPositionY + 140, 120, 30);

                labelSignupPassword = new JLabel("Password ");
                labelSignupPassword.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                labelSignupPassword.setBounds(LoginPositionX, LoginPositionY + 180, 120, 30);

                // login textfields
                textfieldSignupUsername = new JTextField();
                textfieldSignupUsername.setBounds(LoginPositionX + 120, LoginPositionY + 100, 250, 30);
                textfieldSignupUsername.setFont(new Font(FontDefault, Font.PLAIN, font_size3));

                textfieldSignupMobileNumber = new JTextField();
                textfieldSignupMobileNumber.setBounds(LoginPositionX + 120, LoginPositionY + 140, 250, 30);
                textfieldSignupMobileNumber.setFont(new Font(FontDefault, Font.PLAIN, font_size3));

                passwordFieldSignupUser = new JPasswordField();
                passwordFieldSignupUser.setBounds(LoginPositionX + 120, LoginPositionY + 180, 250, 30);
                passwordFieldSignupUser.setFont(new Font(FontDefault, Font.PLAIN, font_size3));

                btnUserSignupAttempt = new JButton("Signup");
                btnUserSignupAttempt.setBounds(LoginPositionX + 120, LoginPositionY + 260, 100, 30);
                btnUserSignupAttempt.setFont(new Font(FontDefault, Font.BOLD, font_size3));
        ...
        btnAdmin.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                labelAdminLogin.setBounds(LoginPositionX + 100, LoginPositionY, 200, 60);
                labelAdminLogin.setFont(new Font(FontDefault, Font.BOLD, font_size1));
                labelAdminLogin.setForeground(Color.RED);

                labelAdminPassword = new JLabel("Root Password");
                labelAdminPassword.setBounds(LoginPositionX, LoginPositionY + 100, 120, 30);
                labelAdminPassword.setFont(new Font(FontDefault, Font.BOLD, font_size3));

                passwordFieldAdmin = new JPasswordField();
                passwordFieldAdmin.setBounds(LoginPositionX + 120, LoginPositionY + 100, 250, 30);
                passwordFieldAdmin.setFont(new Font(FontDefault, Font.PLAIN, font_size3));

                btnAdminLoginAtttempt = new JButton("Login");
                btnAdminLoginAtttempt.setBounds(LoginPositionX + 120, LoginPositionY + 200, 100, 30);
                btnAdminLoginAtttempt.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                ...
                btnAdminUser.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                ...
                btnAdminLoginAtttempt.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent arg0) {
                        ...
                        if (!String.valueOf(passwordFieldAdmin.getPassword()).equals(AdminPassword)) {
                            ...
                            labelAdminAddItemsHeader.setFont(new Font(FontDefault, Font.BOLD, font_size1));

                            // admin conrtol buttons
                            btnAdminControl = new JButton("Control Panel");
                            btnAdminControl.setBounds(0, 100, 150, 50);
                            btnAdminControl.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                            ...
                            btnAdminControlDelete.setBounds(width - 170, height - 100, 150, 50);
                            btnAdminControlDelete.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                            ...
                            btnAdminMarket.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                            ...
                            btnAdminMarketAdditem.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                            ...
                            btnAdminMarketDelete.setBounds(width - 170, height - 100, 150, 50);
                            btnAdminMarketDelete.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                            ...
                            btnAdminViewOrders.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                            ...
                            btnAdminOrderView.setBounds(width - 170, height - 100, 150, 50);
                            btnAdminOrderView.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                            ...
                            btnAdminLogout.setBounds(0, height - 100, 150, 50);
                            btnAdminLogout.setFont(new Font(FontDefault, Font.BOLD, font_size3));
                            ...
                            for (int i = 0; i <= users.newUserID; i++) {
                                ...
                                labelAdminControlUserID[i].setFont(new Font(FontDefault, Font.PLAIN, font_size3));

                                labelAdminControlUsername[i] = new JLabel(users.username[i]);
                                labelAdminControlUsername[i].setBounds(300, (150 + 30 * (i + 1)), 300, 30);
                                labelAdminControlUsername[i].setFont(new Font(FontDefault, Font.PLAIN, font_size3));

                                labelAdminControlMobileNo[i] = new JLabel(users.mobileNo[i]);
                                labelAdminControlMobileNo[i].setBounds(600, (150 + 30 * (i + 1)), 300, 30);
                                labelAdminControlMobileNo[i].setFont(new Font(FontDefault, Font.PLAIN, font_size3));
                            ...
                            for (int i = 0, j = orders.newOrderID; j >= 0; j--) {
                                ...
                                labelAdminOrderID[i].setFont(new Font(FontDefault, Font.PLAIN, font_size3));

                                labelAdminOrderDate[i] = new JLabel(orders.date[j]);
                                labelAdminOrderDate[i].setBounds(300, (150 + 30 * (i + 1)), 300, 30);
                                labelAdminOrderDate[i].setFont(new Font(FontDefault, Font.PLAIN, font_size3));

                                labelAdminOrderUsername[i] = new JLabel(orders.username[j]);
                                labelAdminOrderUsername[i].setBounds(600, (150 + 30 * (i + 1)), 300, 30);
                                labelAdminOrderUsername[i].setFont(new Font(FontDefault, Font.PLAIN, font_size3));
                                ...
                                labelAdminOrderTotalPrice[i].setFont(new Font(FontDefault, Font.PLAIN, font_size3));
                                    ...
                                    for (int i = 0; i <= users.newUserID; i++) {
                                        if (checkboxAdminControl[i].isSelected()) {
                                            ...
                                            for (int k = 0; k <= users.newUserID; k++) {
                                                ...
                                                labelAdminControlUserID[k].setFont(new Font(FontDefault, Font.PLAIN, font_size3));

                                                labelAdminControlUsername[k] = new JLabel(users.username[k]);
                                                labelAdminControlUsername[k].setBounds(300, (150 + 30 * (k + 1)), 300, 30);
                                                labelAdminControlUsername[k].setFont(new Font(FontDefault, Font.PLAIN, font_size3));
                                                ...
                                                labelAdminControlMobileNo[k].setFont(new Font(FontDefault, Font.PLAIN, font_size3));
